...
<div class="row" style="background-color :  rgb(27,27,27)">
	...
	<div class="col-md-4" style="margin:auto;  ">
		...
		<div class="col-md-4">
					...
					<input class="form-control form-control-lg" type="password" id ="old" name="old" placeholder="Enter old Password" >
				</div>
				<div class="col-md-4">
	...
	<div class="col-md-4"> 
						<a type="button " class="btn btn-outline-danger btn-block btn-lg" href="iqac_dashboard.php"> <i class="fa fa-ban" aria-hidden="true"></i>   CANCEL</a>
						</div>
